...
We as members, contributors, and leaders pledge to make participation in the `sk_pqc`
...
Because `sk_pqc` is **cryptographic** software, positive conduct here also means:

- **Intellectual honesty about security claims.** Do not overstate assurance. We say
  "quantum-resistant" / "post-quantum," never "quantum-proof," "quantum-safe," or
  "unbreakable." A hybrid claim states that it holds as long as **either** leg (X25519
  **or** ML-KEM-768) is unbroken, and cites evidence (surface + FIPS number +
  hybrid-vs-classical).
- **Good-faith review of crypto changes.** Combiner, label, and wire-format changes
  affect every peer across the Python / Dart / Rust implementations; engage with the
  parity/vector gate rather than around it.
- **Responsible disclosure.** Report vulnerabilities privately per
  [SECURITY.md](SECURITY.md), never as a public "gotcha."
...
maintainer contact listed on the
[`smilinTux/sk-pqc-rs`](https://github.com/smilinTux/sk-pqc-rs) GitHub organization.
